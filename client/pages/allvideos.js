...
export const getStaticProps = async () => {
  const query = groq`{"videos": *[_type == 'video'] | order(publishedAt desc)[0..3]{_id,title,description,publishedAt,
    'categories': categories[]->title,
    'authorName': author->name,
    'authorSlug': author->slug,
    'authorImage': author->image,
'videoWithDetatils':videoWithDetatils.video.asset->{
  			...,
            ...
            foundTitle.map((video, index) => (
              ...
              >
                ...
                <MuxPlayer
                  ...
                  playbackId={video.videoWithDetatils.playbackId}
                />
                <div className="mt-4">
